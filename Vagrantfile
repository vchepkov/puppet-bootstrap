...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "puppet", primary: true do |puppet|
    ...
    puppet.vm.network "private_network", ip: "192.168.56.20", virtualbox__hostonlyadapter: "puppet"
  ...
  config.vm.define "node", autostart: false do |node|
    ...
    node.vm.network "private_network", ip: "192.168.56.21", virtualbox__hostonlyadapter: "puppet"
